...
function addNews(){
 ...
 let btn=document.getElementById('btnViewNews');if(!btn){btn=document.createElement('button');btn.id='btnViewNews';btn.className='nav-tab-btn';btn.type='button';btn.innerHTML='📰 Новости';btn.onclick=()=>switchPage('news');controls.insertBefore(btn,document.getElementById('btnViewMetro')||controls.firstChild)}
