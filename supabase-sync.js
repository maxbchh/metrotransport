...
(function () {
  ...
  function loadFeatures(){if(document.getElementById('railphotoFeatureScript'))return;const s=document.createElement('script');s.id='railphotoFeatureScript';s.src='railphoto-features.js?v=4';s.onload=()=>console.log('Railphoto feature module loaded');s.onerror=e=>console.error('Railphoto feature module failed',e);document.head.appendChild(s);}
