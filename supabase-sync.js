...
(function () {
  ...
  function loadFeatures(){
    ...
    s.id='railphotoFeatureScript';
    s.src='railphoto-features.js?v=5';
    s.onload=()=>loadBoardAttestation();
    s.onerror=()=>loadBoardAttestation();
    document.head.appendChild(s);
  }
  function loadBoardAttestation(){
    if(document.getElementById('railphotoBoardAttestationScript'))return;
    const s=document.createElement('script');
    s.id='railphotoBoardAttestationScript';
    s.src='railphoto-board-attestation.js?v=1';
    document.head.appendChild(s);
  }
